...
const { prefix } = require('../../../TwitchBot/config/config.json');
        ...
        if (choice.toLowerCase() == 'yes') {
            ...
            if (DBInfo.cmdUsed == null) {
                ...
                db.set(`${message.member.guild.id}.serverSettings.welcomeMsg`, {
                    ...
                    wallpaperURL: './TwitchBot/resources/welcome/wallpaper.jpg',
                    imageWidth: 700,
                    imageHeight: 250,
                ...
                const attachment = new MessageAttachment(
                    '././TwitchBot/resources/welcome/wallpaper.jpg'
                );
                ...
                const embed = new MessageEmbed()
                    ...
                    .addField(`Image Path`, '././TwitchBot/resources/welcome/wallpaper.jpg')
                    .setColor('#420626')
                    .setTimestamp()
                ...
                if (DBInfo.wallpaperURL == '././TwitchBot/resources/welcome/wallpaper.jpg') {
                    const attachment = new MessageAttachment(
                        '././TwitchBot/resources/welcome/wallpaper.jpg'
                    );
