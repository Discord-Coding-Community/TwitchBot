...
const {
    ...
    twitchClientSecret,
    prefix
} = require('../../../TwitchBot/config/config.json');
            ...
            var Ticker = setInterval(async function() {
                ...
                if (currentMsgStatus == 'online') {
                    ...
                    const onlineEmbed = new MessageEmbed()
                        ...
                        .setFooter(
                            'Stream Started',
                            'https://cdn.discordapp.com/avatars/779442792324661249/26206ede07f20447bf380df44b429db7.png' // Official icon link from Twitch.tv
                        )
                        .setImage(
