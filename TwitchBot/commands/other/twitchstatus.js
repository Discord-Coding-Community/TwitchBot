...
const TwitchAPI = require('../../../TwitchBot/resources/twitch/twitch-api.js');
const { MessageEmbed, MessageAttachment } = require('discord.js');
const { twitchClientID, twitchClientSecret } = require('../../../TwitchBot/config/config.json');
...
module.exports = class TwitchStatusCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            group: 'other',
            description: 'A quick check to see if a streamer is currently online. or to give a shout-out a fellow streamer',
            throttling: {
    ...
    async run(message, { textRaw }) {
        ...
        if (streamInfo.data[0] == null) {
            const offlineEmbed = new MessageEmbed()
                ...
                .setFooter(
                    'Joined Twitch',
                    'https://cdn.discordapp.com/avatars/779442792324661249/26206ede07f20447bf380df44b429db7.png'
                )
