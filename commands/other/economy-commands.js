...
module.exports = class EconomyCommandsCommand extends Command {
    ...
    run(message) {
        let embed = new Discord.MessageEmbed()
            ...
            .addField(`${config.prefix}Points`, 'Display\'s the users points.', true)
            .addField(`${config.prefix}Give [@user] [number]`, 'Give a tagged user some pints. *(Guild Onwer Command)*', true)
